                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      $query = "SELECT * FROM apprenants WHERE id_apprenant = '$id_apprenant'";
                      $resulte = mysqli_query($con,$query);
                      while($rows = mysqli_fetch_assoc($resulte)){
                        ?>
                        <span><?php echo $rows["nom"] ?></span> <?php echo $rows["prenom"] ?>
                        <?php 
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">WANHEDA</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <?php 
                    $con = mysqli_connect("localhost","Root","","Application");
                    $sql = "SELECT * FROM apprenants WHERE id_apprenant = '$id_apprenant'";
